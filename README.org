#+title: Chez Euler
  ...
  examples where pretty much all the work problems is done by writing
...
*** Problem 193
    ...
    With values for moebius function in hand, we loop through,
    tallying by inclusion-exclusion.
